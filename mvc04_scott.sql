...
ORDER BY REGIONID;
--> 한 줄 구성
SELECT REGIONID, REGIONNAME, DELCHECK FROM REGIONVIEW WHERE REGIONID=1 ORDER BY REGIONID
;
...
SELECT DEPARTMENTID, DEPARTMENTNAME, DELCHECK FROM DEPARTMENTVIEW WHERE DEPARTMENTID=1 ORDER BY DEPARTMENTID
;

SELECT *
FROM POSITION;

SELECT POSITIONID, POSITIONNAME, DELCHECK FROM POSITIONVIEW WHERE POSITIONID=3 ORDER BY POSITIONID
;
